...
type Props = NativeStackScreenProps<RootStackParamList, 'OnboardingV3'>;
...
export function OnboardingV3Screen({ navigation }: Props) {
  ...
  return (
    <Box surface="screen" style={styles.container}>
      ...
      <BottomBar
        ...
        onPrimaryPress={() => navigation.navigate('FlowInputV3')}
